...
<!-- (menu_additional1, 614c5ced7d3ae0.06165226.8)-->
    ...
    <!-- (rma_methods_form, 61f913c7616e70.19768762.5)-->
								...
								<div class="return_type choose_return_type">
									...
									<div class="return_inner">
										...
										<iaixsl:if test="$n69372_icon_txt and @icon">
											<iaixsl:choose>
												<iaixsl:when test="@id = 3">
													<img class="n69372_icon" src="/gfx/standards/delivery-logistic-parcel_box-shipping-hand.svg?r=1778592039">
														<iaixsl:attribute name="alt"><iaixsl:value-of select="@name"/></iaixsl:attribute>
													</img>
												</iaixsl:when>
												<iaixsl:when test="@id = 1">
													<img class="n69372_icon" src="/gfx/standards/delivery-man.svg?r=1778592039">
														<iaixsl:attribute name="alt"><iaixsl:value-of select="@name"/></iaixsl:attribute>
													</img>
												</iaixsl:when>
												<iaixsl:otherwise>
