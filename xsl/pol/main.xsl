...
<iaixsl:choose>
    <iaixsl:when test="/shop/@preview &gt; 0"><link rel="stylesheet" type="text/css"><iaixsl:attribute name="href">/gfx/<iaixsl:value-of select="language/@id"/>/<iaixsl:value-of select="/shop/@preview"/>/main_style.css?r=779111371</iaixsl:attribute></link></iaixsl:when>
    <iaixsl:otherwise><link rel="stylesheet" type="text/css"><iaixsl:attribute name="href">/gfx/<iaixsl:value-of select="language/@id"/>/main_style.css.gzip?r=779111371</iaixsl:attribute></link></iaixsl:otherwise>
</iaixsl:choose>
...
<iaixsl:choose>
    <iaixsl:when test="/shop/@preview &gt; 0"><script ><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/<iaixsl:value-of select="/shop/@preview"/>/main_shop.js?r=1778592114</iaixsl:attribute></script></iaixsl:when>
    <iaixsl:otherwise><script ><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/main_shop.js.gzip?r=1778592114</iaixsl:attribute></script></iaixsl:otherwise>
</iaixsl:choose>
...
<!-- (menu_additional1, 614c5ced7d3ae0.06165226.8)-->
        ...
        <!-- (main_banner1, 699632b497c6f7.13617873.6)--><div class="homeHeroAndCats">

  <section class="heroSlider" aria-label="Promocje">
    <div class="heroSlider__main" aria-live="off" data-autoplay="6000" data-slider-json="https://sklepfryz.pl/data/include/cms/skrypty/main/slider.json">

      <a class="heroSlider__mainLink" href="#" aria-label="Przejdź do promocji">
        <span class="heroSlider__badge" data-el="badge" style="display:none;"/>
        <span class="heroSlider__tag" data-el="tag" style="display:none;"/>

        <h2 class="heroSlider__title" data-el="title"/>
        <p class="heroSlider__lead" data-el="lead" style="display:none;"/>
        <p class="heroSlider__extra" data-el="extra" style="display:none;"/>

        <span class="heroSlider__cta" data-el="cta" style="display:none;"/>
      </a>

      <button class="heroSlider__mainNav heroSlider__mainNav--prev" type="button" aria-label="Poprzedni slajd"/>
      <button class="heroSlider__mainNav heroSlider__mainNav--next" type="button" aria-label="Następny slajd"/>

      <div class="heroSlider__progress" aria-hidden="true">
        <div class="heroSlider__progressBar"/>
      </div>

      <div class="heroSlider__srOnly" aria-live="polite" aria-atomic="true" data-el="live"/>
    </div>

    <div class="heroSlider__rail" aria-label="Lista slajdów">
      <button class="heroSlider__nav heroSlider__nav--up" type="button" aria-label="Przewiń miniatury w górę"/>

      <button class="heroSlider__thumbNav heroSlider__thumbNav--prev" type="button" aria-label="Przewiń miniatury w lewo"/>
      <button class="heroSlider__thumbNav heroSlider__thumbNav--next" type="button" aria-label="Przewiń miniatury w prawo"/>

      <ul class="heroSlider__thumbs" role="listbox" aria-label="Slajdy"/>

      <button class="heroSlider__nav heroSlider__nav--down" type="button" aria-label="Przewiń miniatury w dół"/>
    </div>
  </section>
...
<!-- (main_hotspot_zone1, 665db48aecd185.04206305.5)-->
...
<!-- (main_hotspot_zone2, 665db4f9ced187.74670659.5)-->
...
<!-- (main_hotspot_zone3, 665db5129c9d39.78628424.5)-->
...
<!-- (main_hotspot_zone4, 665db525c93f31.55088721.5)-->
