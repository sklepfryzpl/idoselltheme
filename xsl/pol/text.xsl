...
<!-- (menu_additional1, 614c5ced7d3ae0.06165226.8)-->
        ...
        <!-- (text_cms_associated, 614c5cefdc1769.06773402.9)-->
	<iaixsl:if test="/shop/page/cms_products/product or /shop/page/cms_products/opinion">
		...
		<section id="text_cms_associated" class="hotspot mb-5">
			...
			<div class="hotspot-associated products d-flex flex-wrap">
							...
							<iaixsl:choose>
								<iaixsl:when test="$var_icon_second and not($var_icon_second = '/' or $var_icon_second = '') and $var_icon_small_second and not($var_icon_small_second = '/' or $var_icon_small_second = '')">
									<picture>
										...
										<source media="(max-width: 420px)" type="image/jpeg" srcset="{$var_icon_small_second}"/>
