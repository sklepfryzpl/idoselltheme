...
<iaixsl:choose>
    ...
    <iaixsl:otherwise><script ><iaixsl:attribute name="src">/gfx/<iaixsl:value-of select="language/@id"/>/common_shop.js.gzip?r=1778592114</iaixsl:attribute></script></iaixsl:otherwise>
			...
			<script src="/gfx/pol/login.js.gzip?r=1778592114"></script>
...
<!-- (login, 610bfde21ddc07.68417574.12)-->
	...
	<iaixsl:if test="(page/@type = 'login') and (page/login/@type='ok') and not(page/login/response)">
		...
		<iaixsl:variable name="associated_clients"><iaixsl:if test="/shop/accept_orders_of_users_in_company/@active='true'">1</iaixsl:if></iaixsl:variable>
			...
			<div class="login_menu_wrapper col-12 row mx-0 flex-wrap align-items-stretch">
				...
				<iaixsl:if test="/shop/action/shoppinglist/@url or /shop/page/actions/products_requests/@url">
					<div class="login_menu" id="products_login">
						<div class="login_menu_sub">
							<h2>
								<iaixsl:choose><iaixsl:when test="$iconsproducts"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsproducts"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="products" src="/gfx/standards/products.png?r=1778592039"/></iaixsl:otherwise></iaixsl:choose>
								Listy produktów
							</h2>
				...
				<iaixsl:if test="/shop/page/actions/orders_opened/@url or /shop/page/actions/orders_closed/@url">
					<div class="login_menu" id="orders_login">
						<div class="login_menu_sub">
							<h2>
								<iaixsl:choose><iaixsl:when test="$iconsorders"><i><iaixsl:attribute name="class"><iaixsl:value-of select="$iconsorders"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="orders" src="/gfx/standards/orders.png?r=1778592039"/></iaixsl:otherwise></iaixsl:choose>
								Zamówienia
							</h2>
							...
							<a class="btn --outline --extrasmall">
<iaixsl:choose>
									<iaixsl:when test="/shop/page/actions/associated_orders/@unfinished_url and /shop/accept_orders_of_users_in_company/@active='true'">
										<iaixsl:if test="/shop/page/actions/associated_orders/@unfinished_count = 0">
											<iaixsl:attribute name="data-disabled">true</iaixsl:attribute>
											<iaixsl:attribute name="onclick">return false</iaixsl:attribute>
											<iaixsl:attribute name="tabindex">-1</iaixsl:attribute>
										</iaixsl:if>
										<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/actions/associated_orders/@unfinished_url"/></iaixsl:attribute>
									</iaixsl:when>
									<iaixsl:otherwise>
							...
							<a class="btn --outline --extrasmall">
<iaixsl:choose>
									<iaixsl:when test="/shop/page/actions/associated_orders/@finished_url and /shop/accept_orders_of_users_in_company/@active='true'">
										<iaixsl:if test="/shop/page/actions/associated_orders/@finished_count = 0">
											<iaixsl:attribute name="data-disabled">true</iaixsl:attribute>
											<iaixsl:attribute name="onclick">return false</iaixsl:attribute>
											<iaixsl:attribute name="tabindex">-1</iaixsl:attribute>
										</iaixsl:if>
										<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/actions/associated_orders/@finished_url"/></iaixsl:attribute>
									</iaixsl:when>
									<iaixsl:otherwise>
							...
							<iaixsl:if test="page/actions/associated_orders/@count &gt; 0 and $associated_clients = 1">
				...
				<div class="login_menu" id="client_cards">
					<div class="login_menu_sub">
						<h2>
							<iaixsl:choose><iaixsl:when test="$iconsprofit"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsprofit"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="profit" src="/gfx/standards/profity.png?r=1778592039"/></iaixsl:otherwise></iaixsl:choose>
							Rabaty
						</h2>
				...
				<iaixsl:if test="/shop/page/actions/client_edit/@url">
					<div class="login_menu" id="dane_login">
						<div class="login_menu_sub">
							<h2>
								<iaixsl:choose><iaixsl:when test="$iconseditdata"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconseditdata"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="editdata" src="/gfx/standards/editdata.png?r=1778592039"/></iaixsl:otherwise></iaixsl:choose>
				...
				<div class="login_menu" id="returns_login">
					<div class="login_menu_sub">
						<h2>
							<iaixsl:choose><iaixsl:when test="$iconsreturns"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsreturns"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="returns" src="/gfx/standards/returns.png?r=1778592039"/></iaixsl:otherwise></iaixsl:choose>
							Zwroty
						</h2>
				...
				<iaixsl:if test="/shop/rma/@active = 'y' and /shop/rma/@link">
					<div class="login_menu" id="rma_login">
						<div class="login_menu_sub">
							<h2>
							<iaixsl:choose><iaixsl:when test="$iconsrma"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsrma"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="rma" src="/gfx/standards/rma.png?r=1778592039"/></iaixsl:otherwise></iaixsl:choose>
				...
				<iaixsl:if test="(/shop/page/actions/client_rebate_points/@url and not(/shop/page/actions/client_rebate_points/@url='')) or /shop/page/actions/products_points/@available='true' or (/shop/page/actions/points_cms/@url and not(/shop/page/actions/points_cms/@url=''))">
					<div class="login_menu" id="points_login">
						<div class="login_menu_sub">
							<h2>
								<iaixsl:choose><iaixsl:when test="$iconspoints"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconspoints"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="points" src="/gfx/standards/points.png?r=1778592039"/></iaixsl:otherwise></iaixsl:choose>
				...
				<iaixsl:if test="/shop/page/affiliate and /shop/page/affiliate/@link">
					<div class="login_menu" id="affiliate_login">
						<div class="login_menu_sub">
							<h2>
								<iaixsl:choose><iaixsl:when test="$iconsaffiliate"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsaffiliate"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="affiliate" src="/gfx/standards/affiliate.png?r=1778592039"/></iaixsl:otherwise></iaixsl:choose>
								Program partnerski
							</h2>
				...
				<iaixsl:if test="/shop/page/actions/associated_clients and /shop/page/actions/associated_clients/@url and $associated_clients = 1">
					<div class="login_menu" id="associated_clients">
						<div class="login_menu_sub">
							<h2>
								<iaixsl:choose><iaixsl:when test="$iconsassociated"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsassociated"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="points" src="/gfx/standards/points.png?r=1778592039"/></iaixsl:otherwise></iaixsl:choose>
