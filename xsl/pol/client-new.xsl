...
<!-- (menu_messages, 60dd8e79b18501.50382803.13)-->
        ...
        <!-- (cop_modules_client-new, 686289894e23f9.47648050.8)-->
...
<iaixsl:if test="not(/shop/page/client-data/@associated = 'true')">
	<form method="POST" id="COP" class="cop --client-new" action="/client-new.php" enctype="multipart/form-data">
      ...
      <div class="cop__step" data-skeleton="address">
        ...
        <div class="cop__skeleton --content"/>
			...
			<iaixsl:if test="/shop/shopMfaSettings">
  			<div class="cop__step" data-skeleton="mfa">
  				<div class="cop__skeleton"/>
  				<div class="cop__skeleton --content"/>
  			</div>
			</iaixsl:if>
    ...
    <template id="cop_signin_template">
      <div class="cop_signin">
        ...
        <div class="cop_signin__buttons">
          ...
          <a href="#passwordRecover" class="cop_signin__recover"><iaixsl:choose><iaixsl:when test="/shop/client_data/@signin = 'cookie'">Nie pamiętam hasła</iaixsl:when><iaixsl:otherwise>Nie pamiętam loginu lub hasła</iaixsl:otherwise></iaixsl:choose></a>
        </div>
      </div>
    </template>
    
    <template id="cop_recover_template">
      <div class="cop_recover">
        <h5 class="cop__title --small">Nie pamiętasz loginu lub hasła?</h5>
        <div class="cop_recover__inputs f-group">
          <div class="cop_recover__item --login f-feedback">
            <input id="cop_recover_user_email" type="text" class="f-control --validate" name="email" required="required" autocomplete="email" tabindex="1">
            </input>
            <label for="cop_recover_user_email" class="f-label">E-mail</label>
            <div class="f-message"/>
          </div>
        </div>
        <div class="cop_recover__buttons">
          <button type="button" class="cop_recover__button --submit btn --solid --medium">Przypomnij hasło</button>
          <a href="#signin" class="cop_recover__signin">Wróć do standardowego logowania</a>
        </div>
      </div>
    </template>
  ...
  <iaixsl:variable name="blockEmailEdit"><iaixsl:choose><iaixsl:when test="((/shop/page/@type = 'client-new' and /shop/page/client-data/@operation = 'edit') or /shop/page/@type = 'order1' or /shop/page/@type = 'place-order') and /shop/userMfaSettings/configuredMfaModes[mfaMode = 'email']">true</iaixsl:when><iaixsl:otherwise>false</iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
  <iaixsl:variable name="blockPhoneEdit"><iaixsl:choose><iaixsl:when test="((/shop/page/@type = 'client-new' and /shop/page/client-data/@operation = 'edit') or /shop/page/@type = 'order1' or /shop/page/@type = 'place-order') and /shop/userMfaSettings/configuredMfaModes[mfaMode = 'otp']">true</iaixsl:when><iaixsl:otherwise>false</iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
  <iaixsl:variable name="blockEmailClass"><iaixsl:choose><iaixsl:when test="$blockEmailEdit = 'true'">--block-edit</iaixsl:when></iaixsl:choose></iaixsl:variable>
  <iaixsl:variable name="blockPhoneClass"><iaixsl:choose><iaixsl:when test="$blockPhoneEdit = 'true'">--block-edit</iaixsl:when></iaixsl:choose></iaixsl:variable>
      ...
      <div class="cop_contact__wrapper f-group">
        <div class="smile_web_authn">
          ...
          <a href="" class="smile_web_authn__link">
            ...
            <img src="/gfx/custom/smile_icon_small.svg?r=1778592039" alt="smile"/>
            <strong>Błyskawicznie uzupełnij dane dostawy</strong>
          </a>
        </div>
        
        <div class="cop_contact__item --phone f-feedback {$blockPhoneClass}">
        ...
        <div class="cop_contact__item --email f-feedback {$blockEmailClass}">
                ...
                <iaixsl:for-each select="/shop/page/options/countries/country">
                  ...
                  <option>
                    ...
                    <iaixsl:choose>
                      ...
                      <iaixsl:when test="$countryId = ../@delivery_active and ($countriesByProfile = 'false' or /shop/page/options/countries_by_shipping_profile[country/@id = $countryId])">
                        <iaixsl:attribute name="selected">selected</iaixsl:attribute>
                        <iaixsl:attribute name="data-default"><iaixsl:value-of select="@name"/></iaixsl:attribute>
                      </iaixsl:when>
      ...
      <iaixsl:if test="/shop/page/client-data/delivery_data/@use != 'hide'">
        ...
        <div class="cop_address__item --address-data cop_address_data f-group --hidden">
            ...
            <iaixsl:attribute name="aria-hidden">true</iaixsl:attribute>
					...
					<iaixsl:variable name="deliveryRegionId"><iaixsl:value-of select="/shop/page/client-data/addresses-list/address[@default]/@region_id | /shop/page/client-data/delivery_data/@region[string-length() &gt; 0 and . != '0'] | /shop/page/options/countries/@delivery_active | /shop/page/options/countries/country[@selected = 'true']/@id"/></iaixsl:variable>
  ...
  <template id="cop_street_number_template">
    <div class="cop_street_number">
      <img src="/gfx/custom/streetNumber.svg?r=1778592039" alt="streetNumber"/>
...
<!-- (client_new_associated, 614c5d4e60ea56.33314046.7)-->
	<iaixsl:if test="/shop/page/client-data/@associated = 'true' and /shop/accept_orders_of_users_in_company/@active = 'true'">
		<iaixsl:if test="/shop/client_data/client_balance/limit/@value">
			<script>var userLimit = &apos;<iaixsl:value-of select="/shop/client_data/client_balance/limit/@value"/>&apos;;</script>
		</iaixsl:if>
		<div class="associatedClients load-content">
			<div class="associatedClients__header">
				<h4 class="big_label" id="client_header">Zarządzanie użytkownikami</h4>
				<a href="##" id="addClient">Dodaj użytkownika</a>
			</div>

			
			<div class="associatedClients__table" id="associatedClientsList" style="display: none;">
				<div class="associatedClients__row --head">
					<div class="associatedClients__col --login">
						<span>Login</span>
					</div>
					<div class="associatedClients__col --email">
						<span>E-mail</span>
					</div>
					<div class="associatedClients__col --adres">
						<span>Adres</span>
					</div>
					<div class="associatedClients__col --limit">
						<span>Pozostały limit</span>
					</div>
					<div class="associatedClients__col --max1">
						<span>Max 1 zamówienie</span>
					</div>
					<div class="associatedClients__col --max30">
						<span>Max zamówienia z 30 dni</span>
					</div>
					<div class="associatedClients__col --del">
						<span>Akceptacja zamówień</span>
					</div>
					<div class="associatedClients__col --options">
						<span>Opcje</span>
						<span id="editLiteral" class="d-none">Edytuj</span>
					</div>
				</div>
			</div>

			
			<div class="associatedClients__items d-sm-none" id="associatedClientsListMobile">
			</div>

			
			<div class="associatedClientsList_empty" style="display:none;" id="associatedClientsEmpty">
				<p>Brak użytkowniów</p>
			</div>
		</div>

		
		<form action="/ajax/client-new.php" id="editClientForm" class="associatedForm associated_clients" style="display: none;">
			<iaixsl:choose>
				<iaixsl:when test="/shop/page/client-data/delivery_data/@region = ''">
					<iaixsl:attribute name="data-region"><iaixsl:value-of select="/shop/page/client-data/invoice_data/@region"/></iaixsl:attribute>
				</iaixsl:when>
				<iaixsl:otherwise>
					<iaixsl:attribute name="data-region"><iaixsl:value-of select="/shop/page/client-data/delivery_data/@region"/></iaixsl:attribute>
				</iaixsl:otherwise>
			</iaixsl:choose>

			<h4 class="big_label associated__title">
				<iaixsl:attribute name="altTextEdit">
					Edycja użytkownika
				</iaixsl:attribute>
				<iaixsl:attribute name="altTextAdd">
					Dodawanie użytkownika
				</iaixsl:attribute>
				Dodawanie użytkownika
			</h4>

			<input type="hidden" id="addOrEdit" name="editAssociated" value="1"/>

			<div class="associatedForm__group f-group --name">
				<div class="associatedForm__input f-feedback">
					<input id="client_firstname" type="text" class="f-control validate --firstname" name="client_firstname" value="" required="required" maxlength="{/shop/page/input_option/@name}"/>
					<label for="client_firstname" class="f-label">Imię</label>
					<span class="f-control-feedback"/>
				</div>
				<div class="associatedForm__input f-feedback">
					<input id="client_lastname" type="text" class="f-control validate --lastname" name="client_lastname" value="" required="required" maxlength="{/shop/page/input_option/@lastname}"/>
					<label for="client_lastname" class="f-label">Nazwisko</label>
					<span class="f-control-feedback"/>
				</div>
			</div>
			<div class="associatedForm__group f-group --phone">
				<div class="associatedForm__input f-feedback">
					<input id="client_phone" type="tel" class="f-control validate --phone" name="client_phone" data-serialize="#client_region" value="" required="required"/>
					<label for="client_phone" class="f-label">Numer telefonu</label>
					<span class="f-control-feedback"/>
				</div>
			</div>
			<div class="associatedForm__group f-group --email">
				<div class="associatedForm__input f-feedback">
					<input id="client_email" type="text" class="f-control validate --email" name="client_email" value="" required="required"/>
					<label for="client_email" class="f-label">E-mail</label>
					<span class="f-control-feedback"/>
				</div>
			</div>
			<div class="associatedForm__group f-group --login">
				<div class="associatedForm__input f-feedback">
					<input id="client_login" type="text" class="f-control validate --login" name="client_login" maxlength="30" value="" required="required"/>
					<label for="client_login" class="f-label">Login</label>
					<span class="f-control-feedback"/>
				</div>
			</div>

			<div class="associatedForm__group --pass">
				<span>Na adres e-mail wysłany zostanie link logujący, który pozwoli na samodzielne ustalenie hasła przez użytkownika.</span>
			</div>

			<h4 class="associatedForm__label">Limity</h4>
			<div class="associatedForm__group f-group --limits">
				<div class="associatedForm__input f-feedback">
					<input id="assocLimitOnce" type="text" class="f-control validate --orderLimitOnce" name="assocLimitOnce" maxlength="30" value="" required="required"/>
					<label for="assocLimitOnce" class="f-label">Max 1 zamówienie(<span class="userCurrency"><iaixsl:value-of select="/shop/currency/@name"/></span>)</label>
					<span class="f-control-feedback"/>
				</div>
				<div class="associatedForm__input f-feedback">
					<input id="assocLimitMonth" type="text" class="f-control validate --orderLimitMonth" name="assocLimitMonth" maxlength="30" value="" required="required"/>
					<label for="assocLimitMonth" class="f-label">Max zamówienia z 30 dni(<span class="userCurrency"><iaixsl:value-of select="/shop/currency/@name"/></span>)</label>
					<span class="f-control-feedback"/>
				</div>
			</div>
			<h4 class="associatedForm__label">Adres dostawy</h4>
			<div class="associatedForm__adresses">
				<a id="new_delivery_address" href="#new_delivery_address">
					Dodaj nowy adres
				</a>
				<a id="save_delivery_address" href="#save_delivery_address" style="display:none;">
					Zapisz adres
				</a>
				<a id="dropdownAdressMenu" href="#dropdownAdressMenu">
					<iaixsl:if test="count(/shop/page/client-data/addresses-list/address) = 0">
						<iaixsl:attribute name="style">display: none;</iaixsl:attribute>
					</iaixsl:if>
					Wybierz zapisany z listy adresów
				</a>
				<div class="associatedForm__adressesList" style="display: none;">
					<iaixsl:for-each select="/shop/page/client-data/addresses-list/address">
						<a href="#address_{@id}" data-wrapper="#client_new_additional" data-id="{@id}" data-zipcode="{@zipcode}" data-phone="{@phone}" data-region_id="{@region_id}" data-country_name="{@country_name}" data-removable="{@removable}" data-editable="{@editable}" data-used="{@used}">
			...
			<input type="hidden" class="--deliveryAddressId" name="assocDeliveryAddressId" value=""/>
			<div id="adressesForm">
				<div class="associatedForm__group f-group --street">
					<div class="associatedForm__input f-feedback">
						<input id="client_street" type="text" class="f-control validate --street" name="client_street" data-serialize="#client_region" maxlength="30" value="" required="required"/>
						<label for="client_street" class="f-label">Ulica i numer</label>
						<span class="f-control-feedback"/>
					</div>
				</div>
				<div class="associatedForm__group f-group --adres">
					<div class="associatedForm__input f-feedback">
						<input id="client_zipcode" type="text" class="f-control validate --zipcode" name="client_zipcode" data-serialize="#client_region" maxlength="30" value="" required="required"/>
						<label for="client_zipcode" class="f-label">Kod pocztowy</label>
						<span class="f-control-feedback"/>
					</div>
					<div class="associatedForm__input f-feedback">
						<input id="client_city" type="text" class="f-control validate --city" name="client_city" maxlength="40" value="" required="required"/>
						<label for="client_city" class="f-label">Miasto</label>
						<span class="f-control-feedback"/>
					</div>
				</div>
			</div>

			<input type="hidden" id="client_region" name="client_region" value="">
				<iaixsl:choose>
					<iaixsl:when test="/shop/page/client-data/delivery_data/@region = ''">
						<iaixsl:attribute name="value"><iaixsl:value-of select="/shop/page/client-data/invoice_data/@region"/></iaixsl:attribute>
					</iaixsl:when>
					<iaixsl:otherwise>
						<iaixsl:attribute name="value"><iaixsl:value-of select="/shop/page/client-data/delivery_data/@region"/></iaixsl:attribute>
					</iaixsl:otherwise>
				</iaixsl:choose>
			</input>
			<h4 class="associatedForm__label">Uprawnienia</h4>
			<div class="form-group associatedForm__group --checkbox">
				<div class="associatedForm__input">
					<input id="assocPermsOrder" type="checkbox" class="--assocPermsOrder" name="assocPermsOrder" value="y"/>
					<label for="assocPermsOrder" class="f-label">Możliwość zamawiania</label>
				</div>
				<div class="associatedForm__input">
					<input id="assocPermsPayment" type="checkbox" class="--assocPermsPayment" name="assocPermsPayment" value="y"/>
					<label for="assocPermsPayment" class="f-label">Akceptacja zamówień</label>
				</div>
					<input id="assocPermsLogin" type="hidden" class="--assocPermsLogin" name="assocPermsLogin" value="y"/>
			</div>
			<a href="#addUser" id="editUserSend" class="btn --solid --medium --send">
				<iaixsl:attribute name="altTextEdit">
					Dodaj użytkownika
				</iaixsl:attribute>
				<iaixsl:attribute name="altTextAdd">
			...
			<a href="#addUser" id="resetPassSend" class="btn">Reset hasła użytkownika</a>
		</form>

		
		<div id="associatedResetPassConfirm" class="associatedResetPass" style="display: none;">
			<h4 class="big_label associatedResetPass__label">
				Reset hasła
			</h4>
			<span>Czy na pewno chcesz zresetować hasło?</span>
			<span>Link do zmiany hasła zostanie wysłany na adres e-mail użytkownika</span>
			<strong id="associatedEmail"/>
			<a id="passConfirm" class="btn --solid --large" href="#associatedResetPass">
				Zresetuj hasło
			</a>
			<a id="passReset" class="btn" href="#associatedResetPass">
				Anuluj reset hasła
			</a>
		</div>

		
		<div id="associatedResetPass" class="associatedResetPass" style="display: none;">
			<h4 class="big_label associatedResetPass__label">
				Reset hasła
			</h4>
			<i class="icon-true"/>
			<span>Hasło zostało zresetowane.</span>
			<span>Link do zmiany hasła zostanie wysłany na adres e-mail użytkownika</span>
			<strong id="associatedEmail"/>
		</div>
	</iaixsl:if>
